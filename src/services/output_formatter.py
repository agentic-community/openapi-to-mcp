...
if __name__ == "__main__":
    ...
    if result != expected:
        all_validation_failures.append(f"MCP criteria check (meets): Expected {expected}, got {result}")
    ...
    expected = False
    if result != expected:
        all_validation_failures.append(f"MCP criteria check (fails): Expected {expected}, got {result}")
